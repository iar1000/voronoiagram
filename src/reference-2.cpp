...
{
	VoronoiSite* site = event->site();          // get point
	Arc* newArc = beachLine.createArc(site);    // create arc

    // insert as first and last element if beachline is empty
    //  otherwise insert after last arch
